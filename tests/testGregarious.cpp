...
int main() {
    ...
    map<string, float> animalsDistribution = {{KamikazeBehaviour::getBehaviourInstance()->getBehaviourName(),   0},
                                              {FearfulBehaviour::getBehaviourInstance()->getBehaviourName(),    0},
                                              {GregariousBehaviour::getBehaviourInstance()->getBehaviourName(), 100},
                                              {"b_multiple",                                                    0}};
