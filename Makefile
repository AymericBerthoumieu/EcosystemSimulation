...
main : main.cpp Aquarium.o Pet.o Environment.o Animal.o BaseDecorator.o Fin.o
	g++ -Wall -std=c++11 -o main main.cpp Aquarium.o Pet.o Environment.o Animal.o BaseDecorator.o Fin.o -I $(SRCDIR) -lX11 -lpthread
