...
main : main.cpp Aquarium.o Pet.o Environment.o GregariousBehaviour.o FearfulBehaviour.o
	g++ -Wall -std=c++11 -o main main.cpp Aquarium.o Pet.o Environment.o GregariousBehaviour.o FearfulBehaviour.o -I $(SRCDIR) -lX11 -lpthread
