...
main : main.cpp Aquarium.o Pet.o Environment.o Animal.o GregariousBehaviour.o FearfulBehaviour.o KamikazeBehaviour.o BaseDecorator.o Sensor.o Eyes.o Fin.o Shell.o Ears.o PetFactory.o Statistics.o MoveUtils.o
	g++ -Wall -std=c++11 -o main main.cpp Aquarium.o Pet.o Environment.o Animal.o GregariousBehaviour.o FearfulBehaviour.o KamikazeBehaviour.o BaseDecorator.o Sensor.o Eyes.o Fin.o Shell.o Ears.o PetFactory.o Statistics.o MoveUtils.o -I $(SRCDIR) -lX11 -lpthread
