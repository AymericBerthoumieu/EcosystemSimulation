...
testShell : $(TESTSDIR)testShell.cpp Aquarium.o Pet.o Environment.o Animal.o BaseDecorator.o Eyes.o Fin.o Shell.o GregariousBehaviour.o FearfulBehaviour.o KamikazeBehaviour.o PetFactory.o Statistics.o MoveUtils.o
	g++ -Wall -std=c++11 -o testShell $(TESTSDIR)testShell.cpp Aquarium.o Pet.o Environment.o Animal.o BaseDecorator.o Eyes.o Shell.o Fin.o GregariousBehaviour.o FearfulBehaviour.o KamikazeBehaviour.o PetFactory.o Statistics.o MoveUtils.o -I $(SRCDIR) -lX11 -lpthread
