...
testEars : $(TESTSDIR)testEars.cpp Aquarium.o Pet.o Environment.o Animal.o BaseDecorator.o Fin.o Ears.o
	g++ -Wall -std=c++11 -o testEars $(TESTSDIR)testFin.cpp Aquarium.o Pet.o Environment.o Animal.o BaseDecorator.o Fin.o Ears.o -I $(SRCDIR) -lX11 -lpthread
