...
testKamikaze : $(TESTSDIR)testKamikaze.cpp Aquarium.o Pet.o Environment.o Animal.o GregariousBehaviour.o FearfulBehaviour.o KamikazeBehaviour.o Sensor.o BaseDecorator.o Fin.o Ears.o Shell.o Eyes.o PetFactory.o Statistics.o MoveUtils.o
	g++ -Wall -std=c++11 -o testKamikaze $(TESTSDIR)testKamikaze.cpp Aquarium.o Pet.o Environment.o Animal.o GregariousBehaviour.o FearfulBehaviour.o KamikazeBehaviour.o Sensor.o BaseDecorator.o Ears.o Shell.o Fin.o Eyes.o PetFactory.o Statistics.o MoveUtils.o -I $(SRCDIR) -lX11 -lpthread
